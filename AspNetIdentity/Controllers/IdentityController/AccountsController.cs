...
namespace AspNetIdentity.Controllers
{
    ...
    public class AccountsController : BaseApiController
    {
        ...
        public async Task<IHttpActionResult> ConfirmEmail(string userId = "", string code = "")
        {
            ...
            {
                ModelState.AddModelError("", "El Codigo Del Usuario Es Requerido.");
                return BadRequest(ModelState);
            }
        ...
        public async Task<IHttpActionResult> AssignRolesToUser([FromUri] string id, [FromBody] string[] rolesToAssign)
        {
            ...
            if (rolesNotExists.Count() > 0)
            {
                ...
                ModelState.AddModelError("", string.Format("Roles '{0}' No Existente En El Sistema.", string.Join(",", rolesNotExists)));
                return BadRequest(ModelState);
            }
            ...
            {
                ModelState.AddModelError("", "Error AL Agregar Role.");
                return BadRequest(ModelState);
            }
